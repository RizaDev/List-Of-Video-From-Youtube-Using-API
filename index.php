...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#home">Riza Syaihikma Rifa'i</a>
  ...
  <div class="jumbotron mb-5" style="height: 720px;" id="home">
    <div class="container">
      <div class="text-center">
        <img src="img/profile1.png" class="rounded-circle img-thumbnail">
        <h1 class="display-4">Riza Syaihikma Rifa'i</h1>
        <h3 class="lead">Lecturer | Programmer | Developer | Designer</h3>
      </div>
    </div>
  </div>
      ...
      <div class="row my-5 pt-5">
        ...
        <div class="col">
          <div class="row ">
            ...
            <div class="col-md-4">
              <h5><?= $channelName; ?></h5>
              <p><?= $subcriber; ?> Subcribers</p>
              <div class="g-ytsubscribe" data-channelid="UCBaYMoEJABWZH18Cug1Fy7Q" data-layout="default" data-count="default"></div>
            </div>
          </div>
  ...
  <!-- Contact -->
  <section class="contact bg-light mt-5" style="height: 800px;" id="contact">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4">
          ...
          <ul class="list-group mb-4">
            ...
            <li class="list-group-item">Jl. Raya Serang Dokan jati RT 03 RW 01 Desa Serang Kec Petarukan Kab Pemalang</li>
  ...
  <footer class="bg-dark text-white mt-5">
    <div class="container">
      <div class="row">
        <div class="col text-center">
          <p>Riza Syaihikma Rifa'i => Copyright &copy; 2022.</p>
        </div>
      </div>
    </div>
  </footer>
